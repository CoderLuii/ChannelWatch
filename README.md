...
Use `coderluii/channelwatch:0.9.11` or `latest` for the current v0.9 release. v0.9.11 keeps idle DVR event streams connected and stops dashboard refreshes from reapplying the timezone override.
